...
class GCAdaBoostClassifier(SKlearnBaseClassifier):
    def __init__(self, name, kwargs):
        from sklearn.ensemble import AdaBoostClassifier
        super(GCAdaBoostClassifier, self).__init__(name, AdaBoostClassifier, kwargs)
    
    def _default_predict_batch_size(self, clf, X):
        return forest_predict_batch_size(clf, X)
    
class GCDecisionTreeClassifier(SKlearnBaseClassifier):
    def __init__(self, name, kwargs):
        from sklearn.tree import DecisionTreeClassifier
        super(GCDecisionTreeClassifier, self).__init__(name, DecisionTreeClassifier, kwargs)
...
class GCRandomTreesEmbedding(SKlearnBaseClassifier):
    def __init__(self, name, kwargs):
        from sklearn.ensemble import RandomTreesEmbedding
        super(GCRandomTreesEmbedding, self).__init__(name, RandomTreesEmbedding, kwargs)
